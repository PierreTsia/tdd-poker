<template>
  <Card>
    <symbol id="H8" viewBox="-500 -500 1000 1000" preserveAspectRatio="xMinYMid">
      <path
    ...
    <use xlink:href="#H8" height="32" width="32" x="-114.4" y="-156" />
...
export default defineComponent({ name: 'Card8H', components: { Card } });
</script>
