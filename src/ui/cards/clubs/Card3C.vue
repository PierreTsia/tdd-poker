<template>
  <Card>
    <symbol id="C3" viewBox="-500 -500 1000 1000" preserveAspectRatio="xMinYMid">
      <path
    ...
    <use xlink:href="#C3" height="32" width="32" x="-114.4" y="-156" />
...
export default defineComponent({ name: 'Card3C', components: { Card } });
</script>
