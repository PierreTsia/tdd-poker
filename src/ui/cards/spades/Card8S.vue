<template>
  <Card>
    <symbol id="S8" viewBox="-500 -500 1000 1000" preserveAspectRatio="xMinYMid">
      <path
    ...
    <use xlink:href="#S8" height="32" width="32" x="-114.4" y="-156" />
    ...
    <use xlink:href="#S" height="70" width="70" x="-35" y="-85.25" />
...
export default defineComponent({ name: 'Card8S', components: { Card } });
</script>
